...
<section class="meteoS">
    ...
    <map name="regionMap">
        <area target="_self" alt="Île-de-France" title="Île-de-France" href="meteo.php?region=Île-de-France#selection"
              ...
              shape="poly"/>
        <area target="_self" alt="Grand Est " title="Grand Est " href="meteo.php?region=Grand%20Est#selection"
        ...
        <area target="_self" alt="Hauts-de-France" title="Hauts-de-France"
              href="meteo.php?region=Hauts-de-France#selection"
              ...
              shape="poly"/>
        <area target="_self" alt="Normandie" title="Normandie" href="meteo.php?region=Normandie#selection"
              ...
              shape="poly"/>
        <area target="_self" alt="Bretagne" title="Bretagne" href="meteo.php?region=Bretagne#selection"
        ...
        <area target="_self" alt="Pays de la Loire" title="Pays de la Loire"
              href="meteo.php?region=Pays%20de%20la%20Loire#selection"
        ...
        <area target="_self" alt="Centre-Val de Loire" title="Centre-Val de Loire"
              href="meteo.php?region=Centre-Val%20de%20Loire#selection"
        ...
        <area target="_self" alt="Auvergne-Rhône-Alpes" title="Auvergne-Rhône-Alpes"
              href="meteo.php?region=Auvergne-Rhône-Alpes#selection"
        ...
        <area target="_self" alt="Nouvelle-Aquitaine" title="Nouvelle-Aquitaine"
              href="meteo.php?region=Nouvelle-Aquitaine#selection"
              ...
              shape="poly"/>
        <area target="_self" alt="Occitanie" title="Occitanie" href="meteo.php?region=Occitanie#selection"
        ...
        <area target="_self" alt="Provence-Alpes-Côte d'Azur" title="Provence-Alpes-Côte d'Azur"
              href="meteo.php?region=Provence-Alpes-Côte%20d'Azur#selection"
              ...
              shape="poly"/>
        <area target="_self" alt="Corse" title="Corse" href="meteo.php?region=Corse#selection"
        ...
        <area target="_self" alt="Bourgogne-Franche-Comté" title="Bourgogne-Franche-Comté"
              href="meteo.php?region=Bourgogne-Franche-Comté#selection"
    ...
    <?php if ($weatherTab["cond"]):?>
        ...
        <div class="meteo">
            ...
            <div class="meteo-in">
                <div class="meteo-info-first">
                    <?php if ($weatherTab["day"] == 0): ?>
                        <p>Nuit</p>
                        <img src="images/lune.png" alt="Icon de lune"/>
                    <?php else: ?>
                        <p>Jour</p>
                        <img src="images/soleil.png" alt="Icon de soleil"/>
                    <?php endif; ?>
                </div>
    ...
    <?php if (isset($_GET["city"]) && $_GET["city"] != null):
        $url = getCityUrl($_GET["city"]);
        $weekly = getWeeklyWeather($url);
        $days = $weekly["forecast"]["forecastday"];
        ?>
        <h2>Prévisions sur 7 jours</h2>
        <div class="weekly-meteo">
            <?php foreach ($days as $day): ?>
                <div class="day-box">
                    <p><strong><?= $day["date"] ?></strong></p>
                    <img src="<?= $day["day"]["condition"]["icon"] ?>" alt="icone météo"/>
